...
<?php if ($size == 'sm'): ?>
  ...
  <div class="text-date"><h1 class="text-dark-blue">Friday <span
        class="weight600">April 8</span></h1></div>
  ...
  <div class="info-container">
      ...
      <ul>
        ...
        <li class="special">
          ...
          <div class="special-text-container">
            <span class="special-text header2 text-dark-blue">Cash ball</span>
          </div>
        </li>
      </ul>
    </div>
    <div class="prizes">
      <ul>
        <li><h2 class="text-dark-blue"><span
              class="weight600">First Prize</span> $1000 a Day For Life
          </h2></li>
        <li><h2 class="text-dark-blue"><span class="weight600">Second Prize</span>
            $1000 a Week For Life</h2></li>
        <li><h2 class="text-dark-blue"><span class="weight600">Next Drawing</span>
            Tonight</h2></li>
      </ul>
    </div>
  </div>
<?php else: ?>
  ...
  <!-- div class="info-container" -->
    <div class="winning-numbers">
      <div class="text-date">
        <h4 class="text-dark-blue">
          ...
          <span class="weight600"><?php print format_date($draw->resultDate/1000, 'draw_date'); ?></span>
        </h4>
      </div>
      <ul>
        <?php foreach ($results as $i => $number): ?>
    ...
    <div class="prizes">
      <div class="row">
        <div class="col-xs-4">
          <h4><span class="weight600">First Prize</span></h4>
          <div class="prize-details-complex">
            <div class="prize-amount-text">
              <h4>$1000</h4>
            </div>
            <div class="prize-schedule-text">
              A DAY<br>FOR LIFE
            </div>
          </div>
        </div>
        <div class="col-xs-4">
          <h4><span class="weight600">Second Prize</span></h4>
          <div class="prize-details-complex">
            <div class="prize-amount-text">
              <h4>$1000</h4>
            </div>
        ...
        <div class="col-xs-4">
          <h4><span class="weight600">Next Drawing</span><br><?= $draw_next; ?>
          </h4>
        </div>
      </div>
